...
from app.services.conversion_service import convert_audio_to_text, convert_audio_to_text
...
def post_voice_message():
    if 'audio' in request.files:
        ...
        new_message = MessageModel(name_audio=save_audio_to_s3(audio), is_audio=True, text=convert_audio_to_text(audio))
